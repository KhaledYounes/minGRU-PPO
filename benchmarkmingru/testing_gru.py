...
class GRULanguageModel(nn.Module):
    def __init__(self, vocab_size, embed_dim, hidden_dim, num_layers):
        ...
        self.stacked_gru = StackedGRU(embed_dim, hidden_dim, num_layers, use_norm=True, use_residual=True)
    ...
    def forward(self, x, hidden=None):
        embed = self.embed(x)
        out, hidden = self.stacked_gru(embed, hidden)
        logits = self.fc(out)
